...
public class GitCloneTest extends AbstractJavaSamplerClient {
    ...
    private static final AtomicInteger subDirNum = new AtomicInteger(0);
    ...
    public Arguments getDefaultParameters() {
        ...
        arguments.addArgument("gitURI", "https://github.com/yuweibo/jmeter.git");
        arguments.addArgument("gitBaseDir", "/Users/yuweibo/Downloads/git_clone_test");
        return arguments;
    }
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
            //prepare subDir
            String subDirStr = gitBaseDir + File.separator + subDirNum.incrementAndGet();
